...
## 0.5.0-beta04 — 2026-08-23

这个版本把上一轮已经完成但未进入 Beta03 的界面和图标提交正式合并，并改善外部插件页面的使用体验。
...
- MYCOMIC 章节范围修复发布在独立插件 `0.1.4`，主 App 仍不包含真实站点适配器。

### 验证

- `gradle test` 通过；
- release APK 公共表面检查不包含 MYCOMIC 真实实现。
