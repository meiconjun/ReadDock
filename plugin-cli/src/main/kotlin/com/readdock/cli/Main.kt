...
import com.readdock.source.runtime.PluginParseResult
import com.readdock.source.runtime.PluginSignature
import com.readdock.source.runtime.PluginTrustStore
import com.readdock.source.runtime.PluginLoadResult
import com.readdock.source.runtime.PluginRepositoryIndexLoader
import com.readdock.source.runtime.SignedPluginEnvelope
import com.readdock.source.runtime.sha256Hex
...
/** Small, offline-first developer CLI for ReadDock plugin packages. */
object Cli {
    private val usage = """
ReadDock Plugin CLI

Usage:
  readdock-source init <directory> [--id <plugin-id>] [--name <name>]
  readdock-source validate <package-or-directory> [--require-signature --public-key <pem> --key-id <id>]
  readdock-source test <package-or-directory> [--fixture-dir <directory>]
  readdock-source fixture capture <https-url-or-file> <output-file> [--force]
  readdock-source package <package-or-directory> <output-file> [--private-key <pem> --key-id <id>]
  readdock-source keygen <directory> [--force]
""".trimIndent()
...
""".trimIndent() + "\n"
    ...
    private fun loader(parsed: Options, err: Appendable): PluginPackageLoader? {
        ...
        val verifier = if (publicKeyPath == null) null else {
            ...
            com.readdock.source.runtime.PluginSignatureVerifier(
    ...
    private fun verifyFixtureExpectations(
        ...
        comics: List<com.readdock.source.api.ComicSummary>,
        detail: com.readdock.source.api.ComicDetail,
        pages: List<com.readdock.source.api.ComicPage>
    ) {
